class CuentaBancaria:
    ...
    def transferir(self, cuenta_destino, monto):
        ...
        saldo_anterior_origen = self.saldo
        saldo_anterior_destino = cuenta_destino.saldo

        self.saldo -= monto
        cuenta_destino.saldo += monto
        
        if (self.saldo == saldo_anterior_origen - monto and 
            cuenta_destino.saldo == saldo_anterior_destino + monto):
            ...
            self.saldo = saldo_anterior_origen
            cuenta_destino.saldo = saldo_anterior_destino
            print("Error en la transferencia. Verifique los saldos.")
            return False
